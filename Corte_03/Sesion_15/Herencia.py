...
def main():
    jugador1=Futbolista('Radamel Falcao García',35, '1234567890','Colombia',34)
    jugador2=Tenista('Roger Federer',42,'0987654321',6,12)
    jugador3=Deportista('Magnus Carlsen', 32,'2468013579')
